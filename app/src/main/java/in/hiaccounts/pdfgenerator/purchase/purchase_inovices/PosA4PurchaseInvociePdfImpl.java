 ...
 */
public class PosA4PurchaseInvociePdfImpl implements PosPurchaseInvoicePdf {

    @Override
    public void generatePurchaseTaxInvoice(Context context, Checkout_ResponseData retailPrintDTO, OutputStream outPutStream, InputStream inputStream) throws IOException, DocumentException {
...
*/
        ...
        header.add(new Chunk(Constant.PDF_PURCHASE_TITLECHECKOUT, fontHeader));
       ...
       // Paragraph compnayInfo = new Paragraph();
        ...
        if (retailPrintDTO.getPiData()!=null) {
            ...
            if (retailPrintDTO.getCompanyData() != null) {
                ...
                if (retailPrintDTO.getPiData().getSupplierInvNo() != null)
                    billingInoChunks.add(new Chunk(retailPrintDTO.getPiData().getSupplierInvNo(), fontTax));
                billingInoChunks.add(new Chunk(Chunk.NEWLINE));
           ...
           /* compnayInfo.setAlignment(Element.ALIGN_LEFT);
            ...
            if (retailPrintDTO.getPiData().getSupplierInvNo() != null)
                compnayInfo.add(new Phrase(new Chunk(retailPrintDTO.getPiData().getSupplierInvNo(), fontTax)));
            compnayInfo.add(Chunk.NEWLINE);
...
*/
            ...
            String inventGSTIN = "", inventCustomerName = "", inventAddress = "", inventState = "", inventDate = "";
            if (retailPrintDTO.getCompanyData() != null) {
        ...
        for (SelectedItemsList selectedItem : itemsList) {
            ...
            if (retailPrintDTO.getPiData().getTaxType()!=null) {
                if (retailPrintDTO.getPiData().getTaxType().equals("CGST:SGST/UGST")) {
                    itemCgstsgstsplitvalues = "" + String.format("%.2f", ((selectedItem.getTaxamt()-selectedItem.getCessTaxAmt()) / 2));
                ...
                if (retailPrintDTO.getPiData().getTaxType().equals("IGST")) {
                    itemCgstsgstsplitvalues = "" + String.format("%.2f", ((selectedItem.getTaxamt()-selectedItem.getCessTaxAmt())));
