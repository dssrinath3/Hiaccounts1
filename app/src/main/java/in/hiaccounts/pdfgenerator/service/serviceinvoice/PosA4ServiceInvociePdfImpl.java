...
public class PosA4ServiceInvociePdfImpl implements PosServiceInvoicePdf {
    @Override
    public void generateTaxInvoice(Context context, ServiceSaveData retailPrintDTO, OutputStream outPutStream, InputStream inputStream) throws IOException, DocumentException {
...
*/
        ...
        header.add(new Chunk(Constant.PDF_TITLE_SALESINVOICE, fontHeader));
        ...
        if (retailPrintDTO.getCompanyData() != null) {
            ...
            if (retailPrintDTO.getCompanyData() != null) {
                in.hiaccounts.hinext.service.model.service_invoice.CompanyData companyData = retailPrintDTO.getCompanyData();
                ...
                if (retailPrintDTO.getSrlnNo() != null)
                    billingInoChunks.add(new Chunk(retailPrintDTO.getSrlnNo(), fontTax));
                billingInoChunks.add(new Chunk(Chunk.NEWLINE));


                billingInoChunks.add(new Chunk(Constant.PDF_INVDATE , fontTaxBold));
                if (retailPrintDTO.getDateOfInvoice() != null)
                    billingInoChunks.add(new Chunk(retailPrintDTO.getDateOfInvoice(), fontTax));
            }
        ...
        if (retailPrintDTO.getSiData() != null) {
            compnayInfo.add(new Phrase(new Chunk(Constant.PDF_INVNO, fontTaxBold)));
            compnayInfo.add(new Chunk(" : ",fontTax));
            if (retailPrintDTO.getSiData().getSrlnNo() != null)
                compnayInfo.add(new Phrase(new Chunk(retailPrintDTO.getSiData().getSrlnNo(), fontTax)));
            compnayInfo.add(Chunk.NEWLINE);
        }
...
*/
            ...
            if (retailPrintDTO != null)

            {
                if (retailPrintDTO.getCustomerGst() != null) {
                    inventGSTIN = retailPrintDTO.getCustomerGst();
                }
                if (retailPrintDTO.getCutomerName() != null) {
                    inventCustomerName = retailPrintDTO.getCutomerName();
                }
                if (retailPrintDTO.getCustomerAddress() != null) {
                    inventAddress = retailPrintDTO.getCustomerAddress();

                }
                if (retailPrintDTO.getCustomerState() != null) {

                    inventState = retailPrintDTO.getCustomerState();

                }
                if (retailPrintDTO.getSrlnNo() != null) {

                    inventNo = retailPrintDTO.getSrlnNo();
            ...
            {
                if (retailPrintDTO.getLocationGst() != null) {
                    locationGSTIN = retailPrintDTO.getLocationGst();
                }
                if (retailPrintDTO.getCustomerObj() != null) {
                    locationCustomerName = retailPrintDTO.getCustomerObj().getCustomerName();
                }
                if (retailPrintDTO.getLocationAddress() != null) {
                    locationAddress = retailPrintDTO.getLocationAddress();

                }
                if (retailPrintDTO.getLocationState() != null) {

                    locationState = retailPrintDTO.getLocationState();

                }
                if (retailPrintDTO.getSrlnNo() != null) {

                    locationInNo = retailPrintDTO.getSrlnNo();
            ...
            {
                locationInDate = retailPrintDTO.getDateOfInvoice();
            }
            ...
            chunkList.add(new Chunk(Chunk.NEWLINE));
            chunkList.add(new Chunk(Constant.PDF_INVNO , fontTaxBold));
            ...
            List<in.hiaccounts.hinext.service.model.SelectedItemsList> itemsList = retailPrintDTO.getSelectedItemsList();
            int j = 1;
            for (
                    in.hiaccounts.hinext.service.model.SelectedItemsList selectedItem : itemsList)

            {
                ...
                if (retailPrintDTO.getTaxType() != null) {
                    if (retailPrintDTO.getTaxType().equals("CGST:SGST/UGST")) {
                    ...
                    if (retailPrintDTO.getTaxType().equals("IGST")) {
            ...
            if (retailPrintDTO.getCessTotalTaxAmt() != 0)
                bottomTotalTable.addCell(getBottomTableCell("" + retailPrintDTO.getCessTotalTaxAmt(), PdfPCell.ALIGN_RIGHT, fontTax));

            String totalAmtGST = "";
            if (retailPrintDTO.getTotalTaxAmt() != 0) {
                if (retailPrintDTO.getCessTotalTaxAmt() != 0) {
                    totalAmtGST = "" + String.format("%.2f", retailPrintDTO.getTotalTaxAmt() - retailPrintDTO.getCessTotalTaxAmt());
                } else {
                    totalAmtGST = "" + String.format("%.2f", retailPrintDTO.getTotalTaxAmt());
                }
            }
            ...
            String totalAmtCess = "";
            if (retailPrintDTO.getCessTotalTaxAmt() != 0) {
                totalAmtCess = "" + String.format("%.2f", retailPrintDTO.getCessTotalTaxAmt());
            }
            ...
            String totalAmtInc = "";
            /*if (retailPrintDTO.getSelectedItemsList().getTotalIncludingTax() != 0) {
            ...
            String totalAmtPaid = "";
          /*  if (retailPrintDTO.getTotalPaid() != 0) {
                totalAmtPaid = "" + String.format("%.2f", retailPrintDTO.getTotalPaid());
            }*/
            bottomTotalTable.addCell(getBottomTableCell(Constant.PDF_ADVANCEPAYMENT, PdfPCell.ALIGN_RIGHT, fontTaxBold));
            bottomTotalTable.addCell(getBottomTableCell(":", PdfPCell.ALIGN_CENTER, fontTax));
            bottomTotalTable.addCell(getBottomTableCell(totalAmtPaid, PdfPCell.ALIGN_RIGHT, fontTax));

            String totalAmtBalance = "";
          /*  if (retailPrintDTO.getBalance() != 0) {
