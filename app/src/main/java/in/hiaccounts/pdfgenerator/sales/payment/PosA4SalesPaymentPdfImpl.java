 ...
 */
public class PosA4SalesPaymentPdfImpl implements PosSalesPaymetPdf {

    @Override
    public void generatePaymentPdf(Context context, SavePaymentPrintResponse printData, OutputStream outPutStream, InputStream inputStream) throws IOException, DocumentException {
        ...
        companyInfoTable.setWidths(new float[]{0.70f,2, 2});
        ...
        if (inputStream != null) {
            ...
            image.scaleAbsolute(55, 55);
            companyInfoTable.addCell(getTableCell(image, Element.ALIGN_BOTTOM, Element.ALIGN_BOTTOM));
        } else {
            ByteArrayOutputStream stream = new ByteArrayOutputStream();
       ...
       /* Paragraph header1 = new Paragraph();
        ...
        invBalanceAmt=""+printData.getBalanceAmount();
