 ...
 */
public class PosA4SalesInvociePdfImpl implements PosSalesInvoicePdf {

    @Override
    public void generateTaxInvoice(Context context, Checkout_Sales_ResponseData retailPrintDTO, OutputStream outPutStream, InputStream inputStream) throws IOException, DocumentException {

        Document document = new Document((PageSize.A4));
        PdfWriter.getInstance(document, outPutStream);
        document.open();
        in.hiaccounts.hinext.checkout.model.sales.InventoryLocationData inventoryLocationData = retailPrintDTO.getInventoryLocationData();
...
*/
...

            {
                ...
                if (retailPrintDTO.getSiData().getSrlnNo() != null) {
                    ...
                    inventNo = retailPrintDTO.getSiData().getSrlnNo();
...

            {
                ...
                if (retailPrintDTO.getSiData().getSrlnNo() != null) {
                    ...
                    locationInNo = retailPrintDTO.getSiData().getSrlnNo();
            ...
            java.util.List<SelectedItemsList> itemsList = retailPrintDTO.getSiData().getSelectedItemsList();
            int j = 1;
            for (
            ...
            if (retailPrintDTO.getTaxAmt() != 0) {
                if (retailPrintDTO.getCessTaxAmt() != 0) {
                    ...
                    totalAmtGST = "" + String.format("%.2f", retailPrintDTO.getTaxAmt());
                }
            }
    ...
    @Override
    public void generateTaxInvoiceForQuoattion(Context context, Sales_QuoationResponseData retailPrintDTO, OutputStream outPutStream, InputStream inputStream) throws IOException, DocumentException {
...
*/
        ...
        if (retailPrintDTO.getCompanyData() != null) {
            ...
            if (retailPrintDTO.getCompanyData() != null) {
                ...
                billingInoChunks.add(new Chunk(Constant.PDF_TITLE_SALESSAVEORDERNO + " : ", fontTaxBold));
                if (retailPrintDTO.getSoNo() != null)
                    billingInoChunks.add(new Chunk(retailPrintDTO.getSoNo(), fontTax));
                billingInoChunks.add(new Chunk(Chunk.NEWLINE));
...
*/
...

            {
                ...
                if (retailPrintDTO.getSiData().getCustomerAddress() != null) {
                    inventAddress = retailPrintDTO.getSiData().getCustomerAddress();
...

            {
                ...
                if (retailPrintDTO.getSiData().getLocationAddress() != null) {
                    locationAddress = retailPrintDTO.getSiData().getLocationAddress();
