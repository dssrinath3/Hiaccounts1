...
public class PurchasePaymentData implements Serializable {
    ...
    @Expose
    private List<PurchaseItem> selectedItemsList = null;
     ...
     * @param cutomerName
     */
    public PurchasePaymentData(List<PurchaseItem> selectedItemsList, CashPayment cashPayment, CreditPayment creditPayment, VoucherPayment voucherPayment, double totalCheckOutamt, String paymentType, double totalTaxAmt, String taxType, String cutomerName, double amountReturned, double discountAmount, double totalTenderedAmount) {
        super();
    ...
    public List<PurchaseItem> getSelectedItemsList() {
        return selectedItemsList;
    }

    public void setSelectedItemsList(List<PurchaseItem> selectedItemsList) {
        this.selectedItemsList = selectedItemsList;
    }
