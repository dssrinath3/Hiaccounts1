...
public class AttributeConfigData implements Serializable {
    ...
    @SerializedName("data")
    @Expose
    private List<AttributeConfig> data = null;
    ...
    public List<AttributeConfig> getData() {
        return data;
    }

    public void setData(List<AttributeConfig> data) {
        this.data = data;
    }
