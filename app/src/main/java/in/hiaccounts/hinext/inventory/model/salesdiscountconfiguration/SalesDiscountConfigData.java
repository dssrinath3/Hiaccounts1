...
public class SalesDiscountConfigData implements Serializable {
    ...
    @SerializedName("data")
    @Expose
    public List<SalesDiscountConfigDataDatum> data = null;
    ...
    public List<SalesDiscountConfigDataDatum> getData() {
        return data;
    }

    public void setData(List<SalesDiscountConfigDataDatum> data) {
        this.data = data;
    }
