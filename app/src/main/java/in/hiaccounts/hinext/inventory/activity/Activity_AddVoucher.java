...
public class Activity_AddVoucher extends AppCompatActivity {
    public static String TAG = Activity_AddVoucher.class.getSimpleName();

    String callingFor, LoyaltyType, AmountOrPercent,serverUrl;
    Long itemID, minqty;
    ...
    private void initComponentView() {
        ...
        if (intent != null) {
            ...
            if (callingFor != null) {
                ...
                if (callingFor.equals(Constant.CALL_EDITVOUCHER)) {
                    loyaltySelectDetails = (LoyaltySelectData) intent.getSerializableExtra("voucherData");
