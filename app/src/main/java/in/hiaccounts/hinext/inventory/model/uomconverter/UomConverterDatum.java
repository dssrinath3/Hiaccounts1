...
public class UomConverterDatum implements Serializable {
    ...
    @SerializedName("data")
    @Expose
    public List<UomConverterDatumData> data = null;
    ...
    public List<UomConverterDatumData> getData() {
        return data;
    }

    public void setData(List<UomConverterDatumData> data) {
        this.data = data;
    }
