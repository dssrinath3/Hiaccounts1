...
public class SalesDebitNote_Adapter extends BaseAdapter {
    private List<Printlist_DebitnoteData> paymentInvoiceList;
    private LayoutInflater layoutInflater;

    public SalesDebitNote_Adapter(Activity activity, List<Printlist_DebitnoteData> paymentInvoiceList) {
        super();
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        Printlist_DebitnoteData paymentInvoice = getItem(position);
