...
public class SalesReturnItemListAdpater extends BaseAdapter{
    private List<Sales_ReturnItemData> paymentInvoiceList;
    private LayoutInflater layoutInflater;

    public SalesReturnItemListAdpater(Activity activity, List<Sales_ReturnItemData> paymentInvoiceList) {
        super();
    ...
    @Override
    public Sales_ReturnItemData getItem(int position) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        Sales_ReturnItemData paymentInvoice = getItem(position);
