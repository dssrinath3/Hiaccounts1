...
/**
 * Created by Srinath on 13/1/18.
 */

public class Sales_ProFormaListAdapter extends BaseAdapter{
    private List<PrintList_ProFormaData> paymentInvoiceList;
    private LayoutInflater layoutInflater;

    public Sales_ProFormaListAdapter(Activity activity, List<PrintList_ProFormaData> paymentInvoiceList) {
        super();
    ...
    @Override
    public PrintList_ProFormaData getItem(int position) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        View v = layoutInflater.inflate(R.layout.adapter_sales_proformaitemlist, null);
        ...
        PrintList_ProFormaData invoice = getItem(position);
        if (invoice != null) {
