...
/**
 * Created by srinath on 11/1/18.
 */

public class Sales_DeliveryOrderAdapter extends BaseAdapter {
    private List<Sales_DeliveryOrderListData> paymentInvoiceList;
    private LayoutInflater layoutInflater;

    public Sales_DeliveryOrderAdapter(Activity activity, List<Sales_DeliveryOrderListData> paymentInvoiceList) {
        super();
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.adapter_sales_deliveryorderlist, parent, false);
        ...
        Sales_DeliveryOrderListData paymentInvoice = getItem(position);
