 ...
 * @author Prateek
 */
public class SalesVoucherPayment_Adapter extends BaseAdapter {
    private Activity activity;
    private List<MultiVoucherPayment> voucherPaymentList;
    private LayoutInflater layoutInflater;


    public SalesVoucherPayment_Adapter(Activity activity, List<MultiVoucherPayment> voucherPaymentList) {
        super();
