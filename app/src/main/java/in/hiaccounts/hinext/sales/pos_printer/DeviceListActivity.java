...
public class DeviceListActivity extends AppCompatActivity {
    ...
    public static String EXTRA_PRINTER_TYPE = "printerType";
    ...
    String printerType="",callingFrom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(getResources().getString(R.string.pos_printer_config_title));
        ...
        if (R.id.radioBtn2Pos==radioBtnId){
            UtilView.showLogCat(TAG,"Radio Button default select: 2inch");
            printerType=getResources().getString(R.string.pos_2inch);
        }

        if (R.id.radioBtn3Pos==radioBtnId){
            UtilView.showLogCat(TAG,"Radio Button default select: 3inch");
            printerType=getResources().getString(R.string.pos_3inch);
        }
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                UtilView.showLogCat(TAG,"Radio Button Selection "+rb.getText());
                printerType=rb.getText().toString();
            }
        });
