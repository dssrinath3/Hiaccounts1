...
import in.hiaccounts.hinext.sales.activity.Activity_SalesCheckout;
 ...
 * @author Prateek
 */
public class SalesCardPayment_Adapter extends BaseAdapter {
    ...
    public SalesCardPayment_Adapter(Activity activity, List<CardPaymentList> cardPaymentList) {
        super();
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.adapter_cardpayment, parent, false);
        ...
        viewHolder.textWatcher_cardAmount = new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s == null || s.toString().equals("")) {
                    ...
                    ((Activity_SalesCheckout) activity).setTenderedAmount();
                } else {
                    try {
                        finalViewHolder.edCardamount.setError(null);
