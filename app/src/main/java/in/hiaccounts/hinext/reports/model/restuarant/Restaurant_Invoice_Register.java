...
public class Restaurant_Invoice_Register implements Serializable {
    ...
    @Expose
    public List<SalesReportList> salesReportList = null;
    ...
    @SerializedName("data")
    @Expose
    public List<Restaurant_Invoice_RegisterData> data = null;
    ...
    public List<SalesReportList> getSalesReportList() {
        return salesReportList;
    }

    public void setSalesReportList(List<SalesReportList> salesReportList) {
    ...
    public List<Restaurant_Invoice_RegisterData> getData() {
        return data;
    }

    public void setData(List<Restaurant_Invoice_RegisterData> data) {
        this.data = data;
    }
