...
public class SalesReportInvoiceRegisterAdapter extends ArrayAdapter<SalesReportList> {
    ...
    public SalesReportInvoiceRegisterAdapter(Context context, List<SalesReportList> objectList) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        SalesReportInvoiceRegisterAdapter.Holder holder = null;
        if(convertView == null){
            holder = new SalesReportInvoiceRegisterAdapter.Holder();
            ...
            holder = (SalesReportInvoiceRegisterAdapter.Holder) convertView.getTag();
        }
