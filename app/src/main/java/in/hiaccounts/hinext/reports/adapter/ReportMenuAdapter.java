...
public class ReportMenuAdapter extends RecyclerView.Adapter<ReportMenuAdapter.RecyclerViewHolders> {

    private ArrayList<GridMenu> menuList;
    private Context context;
    Activity mActivity;

    public ReportMenuAdapter(Context context, ArrayList<GridMenu> menuList) {
    ...
    class RecyclerViewHolders extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            Intent intent=new Intent(mActivity,Activity_ReportSubmenu.class);
