...
public class SalesReportOrderAdapter extends ArrayAdapter<Object> {
    ...
    public SalesReportOrderAdapter(Context context, List<Object> objectList) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        SalesReportOrderAdapter.Holder holder = null;
        if(convertView == null){
            holder = new SalesReportOrderAdapter.Holder();
            convertView = layoutInflater.inflate(R.layout.report_sales_order_view, null);
            ...
            holder = (SalesReportOrderAdapter.Holder) convertView.getTag();
        }
