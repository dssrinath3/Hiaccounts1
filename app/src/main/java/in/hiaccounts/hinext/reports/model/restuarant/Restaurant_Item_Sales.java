...
public class Restaurant_Item_Sales implements Serializable {
    ...
    @SerializedName("data")
    @Expose
    public List<Restaurant_Item_SalesData> data = null;
    ...
    public List<Restaurant_Item_SalesData> getData() {
        return data;
    }

    public void setData(List<Restaurant_Item_SalesData> data) {
        this.data = data;
    }
