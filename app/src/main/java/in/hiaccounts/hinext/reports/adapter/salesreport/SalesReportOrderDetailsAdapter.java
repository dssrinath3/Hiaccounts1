...
public class SalesReportOrderDetailsAdapter extends ArrayAdapter<Object> {
    ...
    public SalesReportOrderDetailsAdapter(Context context, List<Object> objectList) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        SalesReportOrderDetailsAdapter.Holder holder = null;
        if(convertView == null){
            holder = new SalesReportOrderDetailsAdapter.Holder();
            convertView = layoutInflater.inflate(R.layout.report_sales_order_details_view, null);
            ...
            holder.setTvSalesItemName((TextView) convertView.findViewById(R.id.tvSalesItemName));
            ...
            holder = (SalesReportOrderDetailsAdapter.Holder) convertView.getTag();
        }
        holder.getTvSalesDate().setVisibility(View.GONE);
        holder.getTvSalesSqNo().setVisibility(View.GONE);
        holder.getTvSalesItemName().setVisibility(View.GONE);
        ...
        if (obj instanceof SalesReportList) {
            ...
            if (salesReportList != null) {
                ...
                if (salesReportList.getItemName() != null)
                    holder.getTvSalesItemName().setText(salesReportList.getItemName());
                ...
                holder.getTvSalesItemName().setVisibility(View.VISIBLE);
    ...
    private class Holder{
        ...
        TextView tvSalesItemName;

        public TextView getTvSalesItemName() {
            return tvSalesItemName;
        }

        public void setTvSalesItemName(TextView tvSalesItemName) {
            this.tvSalesItemName = tvSalesItemName;
        }
