...
public class CustomerRegisterList {
    ...
    @Expose
    public List<CustomerResponseList> customerResponseList = null;
    ...
    @SerializedName("data")
    @Expose
    public List<CustomerRegisterData> data = null;
    ...
    public List<CustomerResponseList> getCustomerResponseList() {
        return customerResponseList;
    }

    public void setCustomerResponseList(List<CustomerResponseList> customerResponseList) {
    ...
    public List<CustomerRegisterData> getData() {
        return data;
    }

    public void setData(List<CustomerRegisterData> data) {
        this.data = data;
    }
