...
public class Restaurant_Day_End implements Serializable {
    ...
    @Expose
    public List<DayEndPojo> dayEndPojos = null;
    ...
    @SerializedName("data")
    @Expose
    public List<Restaurant_Day_EndData> data = null;
    ...
    public List<DayEndPojo> getDayEndPojos() {
        return dayEndPojos;
    }

    public void setDayEndPojos(List<DayEndPojo> dayEndPojos) {
    ...
    public List<Restaurant_Day_EndData> getData() {
        return data;
    }

    public void setData(List<Restaurant_Day_EndData> data) {
        this.data = data;
    }
