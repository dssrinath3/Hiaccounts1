package in.hiaccounts.hinext.reports.model.sales;
...
public class Sales_ItemCommision_Report implements Serializable {
    ...
    @SerializedName("data")
    @Expose
    public List<Sales_ItemCommision_ReportData> data = null;
    ...
    public List<Sales_ItemCommision_ReportData> getData() {
        return data;
    }

    public void setData(List<Sales_ItemCommision_ReportData> data) {
        this.data = data;
    }
