...
public class Restaurant_Day_EndData_Register {
    ...
    @SerializedName("data")
    @Expose
    public List<Restaurant_Day_EndData_Register_Data> data = null;
    ...
    public List<Restaurant_Day_EndData_Register_Data> getData() {
        return data;
    }

    public void setData(List<Restaurant_Day_EndData_Register_Data> data) {
        this.data = data;
    }
