 ...
 * @author Prateek
 */
public class ShippingMethodAdapter extends ArrayAdapter<Object> {
    ...
    public ShippingMethodAdapter(Context context, List<Object> objects) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.controlpanel_adapter_shippingmethod, null);

            holder.setTvShippingMethod((TextView) convertView.findViewById(R.id.tvShippingMethod));
        ...
        if (obj instanceof ShippingDatum) {
            final ShippingDatum shippingData = (ShippingDatum) obj;

            if (shippingData != null) {

                if (shippingData.getShippingMethodName() != null)
                    holder.getTvShippingMethod().setText(shippingData.getShippingMethodName());

                if (shippingData.getShippingMethodDescription() != null)
                    holder.getTvDescription().setText(shippingData.getShippingMethodDescription());

                holder.getTvDescription().setVisibility(View.VISIBLE);
                holder.getTvShippingMethod().setVisibility(View.VISIBLE);
            ...
            holder.getImgviewDelete().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    deleteShippingMethod(shippingData, obj);
    ...
    private void deleteShippingMethod(final ShippingDatum shippingData, final Object obj) {
            ...
            if (isInternetPresent) {
                ...
                pDialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(final SweetAlertDialog sDialog) {
                        ...
                        String url = serverUrl + "/hipos//1/" + Constant.FUNTION_DELETESHIPPINGMETHOD;
                                ...
                                if (result != null) {
                                    ...
                                    if (result.toString() != null && !result.toString().equals(activity.getString(R.string.error_rsonsecode204))) {
                                        ...
                                        try {
                                            ...
                                            ShippingDatum data = gson.fromJson(result.toString(), ShippingDatum.class);
                                            if (data != null) {
                                                if (sDialog != null) {
                        ...
                        try {
                            ...
                            jsonObject.put("shippingMethodId", shippingData.getShippingMethodId());
    ...
    public class Holder {
        ...
        public TextView getTvShippingMethod() {
            return tvShippingMethod;
        }

        public void setTvShippingMethod(TextView tvShippingMethod) {
            this.tvShippingMethod = tvShippingMethod;
        }
