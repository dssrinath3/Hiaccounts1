...
public class Activity_OpeningBalance_Sales extends AppCompatActivity {

    AgentDatum agentDetail;
    public static String TAG = Activity_OpeningBalance_Sales.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_opnbalance_sales);
            ...
            if (balanceAmt.contains("-") || balanceAmt.equals("0")) {
                ...
                if (cust != null) {
                    try {
                        ...
                        jsonObject.put("siDate", selectedDate);
                        jsonObject.put("formNo", invNumber);
                        jsonObject.put("taxamount", taxAmt);
                        jsonObject.put("totalReceivable", totalReceiveable);
                        ...
                        String url = serverUrl + "/hipos//1/" + Constant.FUNTION_SAVESALEOPENING;
                                        ...
                                        if (result != null) {
                                            if (result.equals("invalid")) {
                                                ...
                                                try {
                                                    ...
                                                    SalesInvoiceData data = gson.fromJson(jsonObject.toString(), SalesInvoiceData.class);
    ...
    public void getDatePicker(Activity mActivity) {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(mActivity, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                String selected = String.valueOf(new StringBuilder().append(dayOfMonth).append("/").append(month + 1).append("/").append(year));

                edInvDate.setError(null);
                edInvDate.setText(selected);
