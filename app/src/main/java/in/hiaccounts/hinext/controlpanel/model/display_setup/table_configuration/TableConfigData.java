...
public class TableConfigData implements Serializable{
    ...
    @SerializedName("data")
    @Expose
    public List<TableConfigDataList> data = null;
    ...
    public List<TableConfigDataList> getData() {
        return data;
    }

    public void setData(List<TableConfigDataList> data) {
        this.data = data;
    }
