...
public class PurchaseDuplicateInvoice_Adapter extends BaseAdapter {
   ...
   // private ItemFilter mFilter = new ItemFilter();
    ...
    public PurchaseDuplicateInvoice_Adapter(Activity activity, ArrayList<PurchaseAdvancePayment> invoiceList) {
        super();
