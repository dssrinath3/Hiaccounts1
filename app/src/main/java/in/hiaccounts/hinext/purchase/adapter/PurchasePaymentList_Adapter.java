...
public class PurchasePaymentList_Adapter extends BaseAdapter{
    private List<PurchaseAdvancePayment> paymentInvoiceList;
    private LayoutInflater layoutInflater;

    public PurchasePaymentList_Adapter(Activity activity, List<PurchaseAdvancePayment> paymentInvoiceList) {
        super();
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        View v = layoutInflater.inflate(R.layout.adapter_purchase_paymentlist, null);
