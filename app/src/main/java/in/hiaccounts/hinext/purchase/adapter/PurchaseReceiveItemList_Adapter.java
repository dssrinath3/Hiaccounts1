...
public class PurchaseReceiveItemList_Adapter extends BaseAdapter {

    private List<PurchaseRecieveItemListData> paymentInvoiceList;
    private LayoutInflater layoutInflater;

    public PurchaseReceiveItemList_Adapter(Activity activity, List<PurchaseRecieveItemListData> paymentInvoiceList) {
        super();
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        View v = layoutInflater.inflate(R.layout.adapter_purchase_recieveitemlist, null);
        ...
        PurchaseRecieveItemListData invoice = getItem(position);
            if (invoice != null) {
                ...
                tv_totalamount.setText("" + invoice.getGtAmountPaid());
