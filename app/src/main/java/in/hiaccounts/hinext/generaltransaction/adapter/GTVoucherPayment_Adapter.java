 ...
 * @author Prateek
 */
public class GTVoucherPayment_Adapter extends BaseAdapter {

    Activity activity;
    List<MultiVoucherPayment> voucherPaymentList;
    LayoutInflater layoutInflater;


    public GTVoucherPayment_Adapter(Activity activity, List<MultiVoucherPayment> voucherPaymentList) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(activity).inflate(R.layout.adapter_voucherpayment, parent, false);
        ...
        final MultiVoucherPayment voucherPayment = voucherPaymentList.get(position);
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (s.toString().equals("")) {
                    ...
                    try {
                        ...
                        UtilView.showLogCat("@Flow", "Double amount " + amount);
                        BigDecimal big = new BigDecimal(amount);
                        UtilView.showLogCat("@Flow", "" + Double.parseDouble(String.valueOf(big.setScale(2, RoundingMode.HALF_UP))));
